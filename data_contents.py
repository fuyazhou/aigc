...
# result_path = r"D:\data\findata_test"
# result_with_content_path = r"D:\data\findata_content"

result_path = '/home/featurize/work/finance/data/fin_title'
result_with_content_path = "/home/featurize/work/finance/data/fin_content"
...
config = {
    ...
    "max_retry": 5,
    # "proxy_pages": 5,
    "tunnel": "u207.kdltps.com:15818",
    "username": "t18869614311381",
    "password": "pm4wbq3o",
}
    ...
    while not ok:
        try:
            ...
            if response.status_code == 200:
                ...
                res = pd.Series(res, index=new_columns)
                ok = True
                return res
        except:
            pass
...
def get_content(file_name):
    ...
    df.to_csv(to_path, index=False, encoding='utf_8_sig')
